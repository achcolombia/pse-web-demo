<html>
	...
	<body>
		...
		scp.setAttribute('src', 'https://b2a.pse.com.co/api/automata/b2a.js?id=' + <?php echo $_POST["userType"].$_POST["authorizerId"] ?> + '&ts=' + );
		...
		<script type="text/javascript" src="https://b2a.pse.com.co/api/automata/b2a.js?id=<?php echo $_POST["userType"].$_POST["authorizerId"] ?>&ts=<?php echo time();?>"></script>
